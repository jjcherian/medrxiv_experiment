...
There are some limitations to the bootstrap as you might expect. Generally speaking, we want the data to be independent and identically distributed (i.i.d.). In our simple example, this is equivalent to saying that each coin toss was done with the same type of coin and performed in a manner such that each toss is independent of the prior one. 

## Test Specificity
OK, so can we use the bootstrap to assess our uncertainty regarding 
